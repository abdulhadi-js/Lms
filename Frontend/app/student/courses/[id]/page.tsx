        ...
        {activeLesson ? (
          <div className="max-w-4xl mx-auto pb-24">
            ...
            <div className="bg-white rounded-xl border border-divider shadow-[0_4px_12px_rgba(19,42,19,0.08)] relative overflow-hidden mb-8 min-h-[300px] flex flex-col">
              ...
              {activeLesson.contentType === 'VIDEO' ? (
                ...
                <div className="flex-1 p-8 flex flex-col items-center justify-center text-center bg-slate-50 min-h-[400px]">
                  ...
                  <h3 className="text-xl font-medium text-evergreen mb-2">Document Resource</h3>
                  {activeLesson.contentUrl ? (
            ...
            <div className="mb-10">
              ...
              <h1 className="text-[32px] md:text-[40px] font-bold text-evergreen mb-4 leading-[1.2]">{activeLesson.title}</h1>
