...
async function seed() {
  ...
  try {
    ...
    await usersService.create({
      ...
      campusId: campus.id,
    } as any).catch(() => console.log('Principal user already exists'));
    ...
    await usersService.create({
      ...
      campusId: campus.id,
    } as any).catch(() => console.log('Teacher user already exists'));
    ...
    await usersService.create({
      ...
      campusId: campus.id,
    } as any).catch(() => console.log('Student user already exists'));
